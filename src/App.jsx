...
const SYNDROMES = {
  ...
  uti: {
    ...
    peds:{ tk:"peds-urine", orgs:["E. coli","K. pneumoniae*","P. mirabilis*"],
      ...
      rx:[
        {name:"Uncomplicated cystitis",drugs:["Cephalexin (PO)"],note:"E. coli 92%. First-line oral agent. 500mg BID x 5–7 days is reasonable per recent data."},
        {name:"Cystitis — alternative",drugs:["Nitrofurantoin (PO)"],note:"E. coli 98%. Lower tract ONLY — no renal tissue levels. Never for pyelonephritis."},
        {name:"Pyelonephritis (outpatient)",drugs:["Ceftriaxone x1 (IV) → Cephalexin (PO)"],note:"COPY-ED study supports cephalosporins for outpatient pyelo. Ceftriaxone: E. coli 95%. Give single IV dose in ED, then step-down to cephalexin 500mg BID–QID x 10–14 days. Cefazolin susceptibility (surrogate): E. coli 92%."},
        {name:"Pyelonephritis (outpatient alt)",drugs:["Ceftriaxone x1 (IV) → TMP/SMX (PO)"],note:"TMP/SMX: E. coli 75% — use only if culture confirms susceptibility. 10–14 day course."},
        {name:"Febrile UTI / Pyelonephritis (admit)",drugs:["Ceftriaxone (IV)"],note:"E. coli 95%. For patients not safe for discharge. Transition to PO per culture."},
    ...
    adult:{ tk:"adult-urine", orgs:["E. coli","K. pneumoniae","P. mirabilis"],
      teach:"E. coli dominates (n=2677). Nitrofurantoin (98%) IDSA first-line for uncomplicated cystitis. TMP/SMX at 77% is below ideal at OHSU. Fluoroquinolones no longer first-line per IDSA for uncomplicated UTI. For outpatient pyelonephritis: the COPY-ED study (Ann Emerg Med 2025, 11 US EDs, n=909) showed oral cephalosporins had comparable outcomes to fluoroquinolones/TMP-SMX (treatment failure 17.2% vs 22.5%, p=NS). ~60% of the cephalosporin group received a single IV ceftriaxone dose in the ED before discharge. E. coli fluoroquinolone resistance at OHSU is 79% (urine) — above the 90% susceptibility threshold preferred for empiric therapy. This makes the cephalosporin pathway increasingly attractive.",
      rx:[
        {name:"Uncomplicated cystitis",drugs:["Nitrofurantoin (PO)"],note:"E. coli 98%. IDSA first-line. 100mg BID x 5 days (macrocrystals)."},
        {name:"Cystitis — alternative",drugs:["TMP/SMX (PO)"],note:"E. coli 77% — below ideal threshold. Use if culture confirms susceptibility."},
        {name:"Pyelonephritis (outpatient — preferred)",drugs:["Ceftriaxone x1 (IV) → Cephalexin (PO)"],note:"COPY-ED evidence supports this approach. Give ceftriaxone 1g IV x1 in ED, then cephalexin 500mg BID–QID x 10–14 days. Cefazolin susceptibility (surrogate): E. coli 89%. Avoids fluoroquinolone adverse effects and resistance selection."},
        {name:"Pyelonephritis (outpatient — alternative)",drugs:["Ceftriaxone x1 (IV) → Ciprofloxacin (PO)"],note:"Cipro: E. coli 79% — below ideal for empiric use. Use only if culture confirms susceptibility or patient cannot take cephalosporins."},
        {name:"Pyelonephritis (outpatient — TMP/SMX)",drugs:["Ceftriaxone x1 (IV) → TMP/SMX (PO)"],note:"TMP/SMX: E. coli 77%. IDSA supports if susceptibility confirmed. 14-day course."},
